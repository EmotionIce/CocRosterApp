...
const ADMIN_PUBLISH_ATTEMPTS_PROPERTY = "ADMIN_PUBLISH_ATTEMPTS_V2";
const ADMIN_PUBLISH_ATTEMPT_HISTORY_LIMIT = 8;
const ADMIN_PUBLISH_ATTEMPT_RETENTION_MS = 24 * 60 * 60 * 1000;
const ADMIN_PUBLISH_ATTEMPT_RUNNING_GRACE_MS = 10 * 1000;
const ADMIN_PUBLISH_ATTEMPT_STALE_MS = 7 * 60 * 1000;
...
const AUTO_REFRESH_LIVENESS_HANDLER_NAME = "autoRefreshLivenessTick";
const AUTO_REFRESH_LIVENESS_TRIGGER_ID_PROPERTY = "AUTO_REFRESH_LIVENESS_TRIGGER_ID";
const AUTO_REFRESH_LIVENESS_INTERVAL_MINUTES = 15;
const AUTO_REFRESH_LAST_PERIODIC_TICK_AT_PROPERTY = "AUTO_REFRESH_LAST_PERIODIC_TICK_AT";
const AUTO_REFRESH_LAST_CANONICAL_COMMIT_AT_PROPERTY = "AUTO_REFRESH_LAST_CANONICAL_COMMIT_AT";
const AUTO_REFRESH_BANDWIDTH_COOLDOWN_UNTIL_PROPERTY = "AUTO_REFRESH_BANDWIDTH_COOLDOWN_UNTIL";
const AUTO_REFRESH_BANDWIDTH_FAILURE_COUNT_PROPERTY = "AUTO_REFRESH_BANDWIDTH_FAILURE_COUNT";
const AUTO_REFRESH_SOURCE_READ_BUDGET_MS = 90 * 1000;
const AUTO_REFRESH_PERIODIC_MAX_OVERDUE_MS = 30 * 60 * 1000;
const AUTO_REFRESH_FAILURE_RETRY_BASE_MS = 10 * 60 * 1000;
const AUTO_REFRESH_FAILURE_RETRY_MAX_MS = 40 * 60 * 1000;
const AUTO_REFRESH_FAILURE_RETRY_MAX_ATTEMPTS = 3;
...
const PERMANENT_SCHEDULER_WATCHDOG_VERSION_PROPERTY = "PERMANENT_SCHEDULER_WATCHDOG_VERSION";
const PERMANENT_SCHEDULER_WATCHDOG_VERSION = "hourly-freshness-v2";
const PERMANENT_SCHEDULER_WATCHDOG_INTERVAL_HOURS = 1;
...
const AUTO_REFRESH_UNFINISHED_ATTEMPT_GRACE_MS = AUTO_REFRESH_JOB_WATCHDOG_DELAY_MS;
